...
public class PlaceExtractor {
	public void Toknizeby(String doc) throws IOException {
		...
		String name = null;
		name = sb.toString();
		FileUtils.writeStringToFile(new File("datadir\\Gazetteers\\placename.txt"), name);
	}
	public HashMap<String/*candidate answers*/,String/*document*/> PlaceName
	(String sentence, File namefile) throws IOException {
		...
		while (sentencetoken.hasMoreElements()) {
			...
			while (token.hasMoreElements()) {
				...
				else if ((sentenceword.startsWith("gandaa ")||sentenceword.startsWith("iddoo ")||
						sentenceword.startsWith("bakka ")|| sentenceword.startsWith("magalaa ")||
						sentenceword.startsWith("biyya "))
				...
				else if ((sentenceword.endsWith("kabajammee")||sentenceword.endsWith("gaggeeffame")||
	...
	public static void main(String[] tt) throws IOException {
		...
		pname.Toknizeby("Gazetteers\\placename.txt");
	}
